...
expansion_order, leaf_size, multipole_threshold = 6, 50, 0.4
@time tree_unstructured = pnl.FMM.FastMultipole.fmm!(body_fmm; expansion_order, leaf_size, multipole_threshold, unsort_bodies=true)
