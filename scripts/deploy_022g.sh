...
REMOTE_DIR="${P022G_REMOTE_DIR:-/home/rander39/projects/FLOWPanel-022g}"
[[ "$REMOTE_DIR" == /home/rander39/projects/FLOWPanel-022g ]] || {
  echo "ERROR: refusing non-022g deployment target '$REMOTE_DIR'" >&2; exit 2; }
