...
export JULIA_NUM_THREADS=4 OMP_NUM_THREADS=4 BLAS_NUM_THREADS=4
...
export RESTART_STEP=5
export RESTART_NAME="smoke_2r_oge"
export RESTART_PATH="data/smoke_2r_oge"
export RUN_NAME="smoke_2r_oge_restart"
rm -rf "data/$RUN_NAME"

echo "== smoke $CASE (NROTORS=$NROTORS ground=$GROUND_ENABLE) -> data/$RUN_NAME =="
julia --project=. -t 4 examples/rotor_hover_ground_effect.jl
