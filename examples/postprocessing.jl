...
## Number of cells
n_cells = [1136, 4338, 8842, 16880] # Number of panels on the grid
...
data_c3 = readdlm("CT_v_t_hover_RPM5400_nc8824_pps2_nt36_overlap2.0_kerneloff0.00012.csv", ',')
data_c4 = readdlm("CT_v_t_hover_RPM5400_nc16880_pps2_nt36_overlap2.0_kerneloff0.00012.csv", ',')

t_c = data_c1[2, :]
CT_data_c = [data_c1[2,:] data_c2[2,:] data_c3[2,:] data_c4[2,:]]
...
plt_CT_nc = plot(n_cells, CT_c';
    title   = "Coefficient of Thrust "*L"(n_t = 36, n_p = 2)",
...
plt_conv_nc = plot(1:length(t_c), CT_data_c[:,3];
