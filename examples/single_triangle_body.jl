...
phi_semiinfinite2 = zeros(npoints)
U_semiinfinite2 = zeros(3, npoints)
...
# axs2.plot(dz, abs.(out_direct_z - out_fmm_z), label="error")
axs2.plot(dz, abs.(phi_direct - phi_fmm), label="error")
axs2.set_yscale("log")
axs2.legend()
plt.tight_layout()
plt.show()
