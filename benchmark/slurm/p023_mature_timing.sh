...
julia --project=. -t "$THREADS" benchmark/p018_mature_wake_timing.jl

echo "Finished ($(date '+%F %T')). Results: benchmark/results/p018_mature_wake_timing_t${THREADS}.csv"
